...
class LelManga extends MangaStream_1.MangaStream {
    ...
    configureSections() {
        this.sections['popular_today'].selectorFunc = ($) => $('div.bsx', $('h2:contains(Top Managa Aujourd\'hui)')?.parent()?.next());
        this.sections['latest_update'].selectorFunc = ($) => $('div.uta', $('h2:contains(Dernières Sorties)')?.parent()?.next());
        this.sections['new_titles'].enabled = false;
    }
}
exports.LelManga = LelManga;

},{"../MangaStream":102,"@paperback/types":61}],102:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./LanguageUtils":100,"entities":73}],105:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
