...
},{"./MangaStreamHelper":102,"./MangaStreamParser":103,"./UrlBuilder":105,"@paperback/types":61,"simple-url":99}],102:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@paperback/types":61}],103:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./LanguageUtils":100,"entities":73}],104:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class TeamxNovel extends MangaStream_1.MangaStream {
    ...
    configureSections() {
        ...
        this.sections['latest_update'].selectorFunc = ($) => $('div.uta', $('h1:contains(اخر الفصول)')?.parent()?.parent());
        this.sections['latest_update'].titleSelectorFunc = ($, element) => $('h3', element).text().trim();
        this.sections['latest_update'].subtitleSelectorFunc = ($, element) => $('li > a', element).first().text().trim();
    }
}
exports.TeamxNovel = TeamxNovel;

},{"../MangaStream":101,"@paperback/types":61}],105:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
