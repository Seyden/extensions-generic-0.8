...
},{"base64-js":62,"buffer":64,"ieee754":93}],65:[function(require,module,exports){
'use strict';
...
},{"./":66,"get-intrinsic":86}],66:[function(require,module,exports){
'use strict';
...
},{"es-define-property":76,"es-errors/type":82,"function-bind":85,"get-intrinsic":86,"set-function-length":100}],67:[function(require,module,exports){
'use strict';
...
},{"es-define-property":76,"es-errors/syntax":81,"es-errors/type":82,"gopd":87}],68:[function(require,module,exports){
"use strict";
var __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {
    if (k2 === undefined) k2 = k;
    var desc = Object.getOwnPropertyDescriptor(m, k);
...
},{"./decode_codepoint.js":69,"./generated/decode-data-html.js":72,"./generated/decode-data-xml.js":73}],69:[function(require,module,exports){
"use strict";
...
},{"./escape.js":71,"./generated/encode-html.js":74}],71:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./decode.js":68,"./encode.js":70,"./escape.js":71}],76:[function(require,module,exports){
'use strict';
...
},{"get-intrinsic":86}],77:[function(require,module,exports){
'use strict';
...
},{"es-errors":78,"es-errors/eval":77,"es-errors/range":79,"es-errors/ref":80,"es-errors/syntax":81,"es-errors/type":82,"es-errors/uri":83,"function-bind":85,"has-proto":89,"has-symbols":90,"hasown":92}],87:[function(require,module,exports){
'use strict';
...
},{"es-define-property":76}],89:[function(require,module,exports){
'use strict';
...
},{"function-bind":85}],93:[function(require,module,exports){
...
},{"./util.inspect":63}],95:[function(require,module,exports){
'use strict';
...
},{"./formats":95,"./utils":99,"side-channel":101}],99:[function(require,module,exports){
'use strict';
...
},{"./formats":95}],100:[function(require,module,exports){
'use strict';
...
},{"define-data-property":67,"es-errors/type":82,"get-intrinsic":86,"gopd":87,"has-property-descriptors":88}],101:[function(require,module,exports){
'use strict';
...
},{"call-bind/callBound":65,"es-errors/type":82,"get-intrinsic":86,"object-inspect":94}],102:[function(require,module,exports){
'use strict';
...
},{"qs":96}],103:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class MangaStream {
    constructor(cheerio) {
        ...
        this.sections = {
            'popular_today': {
                ...
                section: (0, MangaStreamHelper_1.createHomeSection)('popular_today', 'Popular Today', true, types_1.HomeSectionType.singleRowLarge),
                ...
                getViewMoreItemsFunc: (page) => `${this.sourceTraversalPathName}/?page=${page}&order=popular`,
                sortIndex: 10
            },
            'latest_update': {
                ...MangaStreamHelper_1.DefaultHomeSectionData,
                ...
                titleSelectorFunc: ($, element) => $('a', element).attr('title'),
                subtitleSelectorFunc: ($, element) => $('li > span', $('div.luf', element)).first().text().trim(),
                getViewMoreItemsFunc: (page) => `${this.sourceTraversalPathName}/?page=${page}&order=update`,
                sortIndex: 20
            },
            'new_titles': {
                ...MangaStreamHelper_1.DefaultHomeSectionData,
                ...
                getViewMoreItemsFunc: (page) => `${this.sourceTraversalPathName}/?page=${page}&order=latest`,
                sortIndex: 30
            },
            'top_alltime': {
                ...MangaStreamHelper_1.DefaultHomeSectionData,
    ...
    async loadRequestData(url, method = 'GET') {
        const request = App.createRequest({
            url,
            method
        });
...
},{"./MangaStreamHelper":105,"./MangaStreamParser":106,"./UrlBuilder":109,"@paperback/types":61,"simple-url":102}],105:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"@paperback/types":61}],106:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class MangaStreamParser {
    ...
    async parseChapterList($, mangaId, source) {
        const chapters = [];
        let sortingIndex = 0;
    ...
    async parseViewMore($, source) {
        ...
        for (const manga of $('div.bs', 'div.listupd').toArray()) {
            ...
            const mangaId = source.usePostIds
                ? (isNaN(Number(postId))
...
},{"./LanguageUtils":103,"entities":75}],107:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
const SkyMangasParser_1 = require("./SkyMangasParser");
...
class SkyMangas extends MangaStream_1.MangaStream {
    constructor() {
        ...
        this.language = '🇪🇸';
        this.parser = new SkyMangasParser_1.SkyMangasParser();
    }
    configureSections() {
        this.sections['popular_today'].selectorFunc = ($) => $('div.bsx', $('h2:contains(Popular Today)')?.parent()?.next());
        this.sections['latest_update'].selectorFunc = ($) => $('div.uta', $('h2:contains(Latest Update)')?.parent()?.next());
...
},{"../MangaStream":104,"./SkyMangasParser":108,"@paperback/types":61}],108:[function(require,module,exports){
(function (Buffer){(function (){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.SkyMangasParser = void 0;
const MangaStreamParser_1 = require("../MangaStreamParser");
class SkyMangasParser extends MangaStreamParser_1.MangaStreamParser {
    parseChapterDetails($, mangaId, chapterId) {
        const pages = [];
        let obj;
        for (const script of $('script[src*="data:text/javascript"]').toArray()) {
            const scriptContent = script.attribs['src'] ?? '';
            if (!scriptContent) {
                continue;
            }
            const encodedContent = Buffer.from(scriptContent.replace('data:text/javascript;base64,', ''), 'base64').toString();
            // To avoid our regex capturing more scrips, we stop at the first match of ";", also known as the first ending the matching script
...
},{"../MangaStreamParser":106,"buffer":64}],109:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
